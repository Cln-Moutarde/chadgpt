...
import { GatewayIntentBits, Client, Collection, SlashCommandBuilder, Events } from "discord.js";
...
client.on(Events.InteractionCreate, async interaction => {
  ...
  try {
    ...
    console.log(error)
    await interaction.reply({content: 'ERROR with the command !', ephemeral: true})
  }
...
client.on("messageCreate", (message) => {
  ...
  if (message.content.includes("chad")) {
    ...
    if (firstmentionuser) {
      ...
      const chad = ["tu es chaddesque", "ta machoir est carrée", "quel BG", "tu as beaucoup trop de charisme"]
